...
namespace WeDevs\DokanMigrator\Dependencies\Appsero;

/**
 * WeDevs\DokanMigrator\Dependencies\Appsero Insights
 *
...
class Insights
{
    ...
    public function __construct($client, $name = null, $file = null)
    {
        ...
        if (is_object($client) && is_a($client, 'WeDevs\DokanMigrator\Dependencies\Appsero\Client')) {
            $this->client = $client;
        }
    }
    ...
    public function admin_notice()
    {
        ...
        $notice .= 'We are using WeDevs\DokanMigrator\Dependencies\Appsero to collect your data. <a href="' . $policy_url . '" target="_blank">Learn more</a> about how WeDevs\DokanMigrator\Dependencies\Appsero collects and handle your data.</p>';
            ...
            <div class="wd-dr-modal-wrap">
                ...
                <div class="wd-dr-modal-body">
                    ...
                    <p class="wd-dr-modal-reasons-bottom">
                        <?php
                        echo sprintf(
                            $this->client->__trans('We share your data with <a href="%1$s" target="_blank">Appsero</a> to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> about how WeDevs\DokanMigrator\Dependencies\Appsero handles your data.'),
